...
using CFD = NLTK.Probability.ConditionalFreqDist;
...
namespace NLTK.Text
{
    ...
    public class ContextIndex
    {
        ...
        private Func<string[], int, string[]> _ContextFunc;
        private Func<string, string> _Key;
        private string[] _Tokens;

        private CFD _WordToContexts;
        private CFD _ContextToWords;

        public ContextIndex(string[] Tokens, Func<string[], int, string[]> ContextFunc = null, Func<string, bool> Filter = null, Func<string, string> Key = null)
        {
            _Tokens = Tokens;

            if (Key == null)
            {
                this._Key = ContextIndex._DefaultKeyFunc;
            }
            else
            {
                this._Key = Key;
            ...
            if (ContextFunc == null)
            {
                this._ContextFunc = ContextIndex._DefaultContextFunc;
            }
            else
            {
            ...
            if(Filter != null)
            {
                _Tokens = Tokens.Where(x => Filter(x)).ToArray();
            }
        }
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        private static string[] _DefaultContextFunc(string[] tokens, int i)
        {
            string left = i != 0 ? tokens[i - 1].ToLower() : "*START*";
            string right = i != tokens.Length - 1 ? tokens[i + 1].ToLower() : "*END*";
            return new string[] { left, right};
        }

        private static string _DefaultKeyFunc(string Token)
        {
            return Token;
        }
    ...
    {
        public ConcordanceIndex(string[] Tokens, Func<string, string> Key = null)
        {
    ...
    public class Text
    {
        ...
        private string[] _Tokens = new string[] { "matt", "anthony", "brad" };
        public List<string> sto = new List<string>();
        ...
        public Text(string[] Tokens, string name = null)
        {
            //this._Tokens = Tokens;
            throw new NotImplementedException();
        }
        ...
        //adds python style array slicing via index
        public string[] this[Range range]
        {
            get
            {
                return this._Tokens[range];
            }
            
        }

        #region "Interactive Console Methods"

        //def concordance(self, word, width=79, lines=25):
        public ConcordanceIndex Concordance(string Word, int Width = 79, int Lines = 25)
        {
            throw new NotImplementedException();
        }

        //def concordance_list(self, word, width=79, lines=25):
        public object ConcordanceList(string Word, int Width = 79, int Lines = 25) //should return some kind of list or array
        {
            throw new NotImplementedException();
        }

        //def concordance_list(self, word, width=79, lines=25):
        public object CollocationList(int Num = 20, int WindowSize = 2) //should return some kind of list or array
        {
            throw new NotImplementedException();
        }

        //def collocations(self, num=20, window_size=2):
        public object Collocations(int Num = 20, int WindowSize = 2)
        {
            throw new NotImplementedException();
        }
